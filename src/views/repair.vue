    ...
    <div class="row flex pd mt-5 mb-5 mx-5">
      <div class="account-element bd-7 rtl my-5">
        <div class="cmt-title text-center abs">
          <h1 class="page-title v6">فرم تکمیل درخواست تعمیر</h1>
        </div>
                ...
                <div class="mymodal-card">
                  <div class="mymodal-body">
                    <div class="mymodal-content">
                      درخواست شما موفقیت آمیز بود با شما در اولین فرصت تماس گرفته خواهد شد
                    </div>
  ...
  methods: {
    ...
    async sendData() {
      if (
        ...
        let mydata = await axios
          .post(
            `https://redico.ir/api/Repairs/cerate_Repairs/${this.$route.params.id}/`,
            {
          ...
          .then((response) => { document.querySelector(".mymodal-page-check").classList.add("open");});
      } else {
        this.error = true;
      }
    },
